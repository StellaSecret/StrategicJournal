...
class GoogleDriveDataSource
    ...
    constructor(
                ...
                try {
                    ...
                    Drive
                        .Builder(
                            ...
                            initializer,
                        ).setApplicationName("StrategicJournal")
                        .build()
                } catch (e: Exception) {
        ...
        suspend fun listEntryFiles(): List<DriveFile> =
            withContext(Dispatchers.IO) {
                try {
        ...
        suspend fun downloadEntry(fileId: String): String? =
            withContext(Dispatchers.IO) {
                try {
                    val drive = buildDriveService() ?: return@withContext null
        ...
        suspend fun deleteEntry(fileId: String): Boolean =
            withContext(Dispatchers.IO) {
                try {
