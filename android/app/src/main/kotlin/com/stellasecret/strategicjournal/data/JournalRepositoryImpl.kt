...
class JournalRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun getEntry(id: String): JournalEntry? = dao.getById(id)?.toDomain(json)

        override suspend fun getEntryByDate(date: String): JournalEntry? = dao.getByDate(date)?.toDomain(json)
