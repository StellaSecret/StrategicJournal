...
class MainActivity : ComponentActivity() {
    ...
    private val signInLauncher = registerForActivityResult(
        ...
        Timber.d("signInLauncher result received: resultCode=${result.resultCode}")
    ...
    private fun handleSignInResult(result: ActivityResult) {
        ...
        try {
            ...
            Timber.d("Sign-in OK: email=${account.email}, hasDriveScope=$hasScope")
            ...
            if (hasScope) {
                ...
                Timber.d("Missing Drive scope, requesting via requestCode...")
            ...
            Timber.e("Sign-in failed: statusCode=${e.statusCode}, message=${e.message}")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == DRIVE_SCOPE_REQUEST_CODE) {
            ...
            Timber.d("Drive scope result: hasScope=$hasScope")
            if (hasScope) {
                Toast.makeText(this, "Connected to Drive ✓", Toast.LENGTH_SHORT).show()
                authStateChanged.value = !authStateChanged.value
            } else {
    ...
    fun launchGoogleSignIn() {
        Timber.d("launchGoogleSignIn called")
        ...
        if (existingAccount != null && GoogleSignIn.hasPermissions(existingAccount, driveScope)) {
            ...
            Timber.d("Already authenticated with Drive scope")
