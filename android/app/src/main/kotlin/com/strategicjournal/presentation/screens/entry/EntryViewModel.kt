...
class EntryViewModel @Inject constructor(
    ...
    fun addHypothesis(statement: String, domain: HypothesisDomain, confidence: Int) {
    ...
    fun addDecision(statement: String, rationale: String, type: DecisionType, reversible: Boolean) {
    ...
    fun addPrediction(statement: String, expectedOutcome: String, deadline: String, confidence: Int) {
